...
def wjug(a,b,ai,bi,af,bf):
    ...
    while ai!=af or bi!=bf:
        op=int(input("Enter type operatiuon(1-8):"))
        if op==1:
            ai=a
        elif op==2:
            bi=b
            ...
            print("Invalid opertaion please choose a number between 1 and 8")
            continue
...
if(af<=a and bf<=b) and (af%gcd==bf%gcd==0):
    ...
    print("The final state  is not achievable with given capabilities ")
    exit(1)
